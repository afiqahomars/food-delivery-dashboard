...
if not filtered_df.empty:
    ...
    ax1.plot(tip_by_day['order_day_of_week'], tip_by_day['tip_amount'], marker='o', color='royalblue', linewidth=2.5)
...
with col1:
    ...
    if not filtered_df.empty:
        ...
        ax2.bar(cancel_counts['prep_time_bin'], cancel_counts['cancel_count'], color='coral', edgecolor='black', alpha=0.85)
